  ...
  q.submit([&](handler &cgh) {
     cgh.parallel_for<class LS<TM, TN>>(
...
#endif
         {
           ...
           joint_matrix<sub_group, T1, use::a, TM, TN, layout::col_major> sub_matrix;
...
int main() {
  ...
  for (unsigned int i = 0; i < combinations.size(); i++) {
    ...
    if (combinations[i].nsize == 16) { // architecture::intel_gpu_pvc
      run_matrix_test<bfloat16, /*TM*/ 8, /*TN*/ 16>();
    //   run_matrix_test<bfloat16, /*TM*/ 7, /*TN*/ 16>();
    //   run_matrix_test<bfloat16, /*TM*/ 6, /*TN*/ 16>();
    //   run_matrix_test<bfloat16, /*TM*/ 5, /*TN*/ 16>();
    //   run_matrix_test<bfloat16, /*TM*/ 4, /*TN*/ 16>();
    //   run_matrix_test<bfloat16, /*TM*/ 3, /*TN*/ 16>();
    //   run_matrix_test<bfloat16, /*TM*/ 2, /*TN*/ 16>();
    //   run_matrix_test<bfloat16, /*TM*/ 1, /*TN*/ 16>();
      break;
    }
